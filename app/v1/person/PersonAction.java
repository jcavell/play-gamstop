...
public class PersonAction extends play.mvc.Action.Simple {
    private final Logger.ALogger logger = play.Logger.of("application.PersonAction");
    ...
    @Singleton
    @Inject
    public PersonAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(PersonAction.class, "responsesTimer"));
    }
